...
(function ($) {
  ...
  /**
   * Builds the markup for a [Bootstrap 4 modal](https://v4-alpha.getbootstrap.com/components/modal/)
  ...
  var buildModal = function (options) {
    ...
    var modal = $(
      '<div class="modal fade '+modalClass+' '+fade+'" id="'+id+'" tabindex="-1" role="dialog" aria-labelledby="'+id+'Label" aria-hidden="true">' +
        '<div class="modal-dialog" role="document">' +
          '<div class="modal-content">' +
            ...
            '<div class="modal-footer">' +
              '<button type="button" class="btn commit btn-warning"></button>' +
              '<button type="button" class="btn cancel btn-success" data-dismiss="modal"></button>' +
            '</div>' +
          '</div>' +
        '</div>' +
      '</div>'
